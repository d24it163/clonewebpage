        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark  pt-5 mt-5" style="width: 280px; min-height: 701px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto ">
                <li class="nav-item text-center">
                    <a href="admin_index.php" class="nav-link text-light">
                        <b>Sales Inquiry</b>
                    </a>
                </li>
                <li class="nav-item text-center">
                    <a href="contact_inquiry.php" class="nav-link text-light" aria-current="page">
                        <b>Contact Inquiry</b>
                    </a>
                </li>
                <li class="nav-item text-center">
                    <a href="home_inquiry.php" class="nav-link text-light active">
                ...
                <tbody class="table-group-divider">
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <form action="remove_home_inquiry.php" method="post">

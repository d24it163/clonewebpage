...
<body>
                    ...
                    <ul class="navbar-nav me-auto ms-5 ">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item active" aria-current="page" href="glasses.php">Eye-Glasses</a></li>
    ...
    <main>
        <div class="album pt-5 my-5 bg-body-tertiary">
            <div class="container">

                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img1.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size:Wide • FloatPop</p>
                                <p class="card-text " style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>1700</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img2.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size:Wide • FloatPop</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>1700</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img3.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size:Wide • FloatPop</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>1700</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img4.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Medium • Matte Essentials</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>2800</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img5.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Medium • Float Pop 2.0</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>2800</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img6.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Wide • Air Prism</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>2800</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img13.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Medium • John Jacobs</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>4000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img14.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Medium • John Jacobs</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>4000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img15.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Extra Wide • John Jacobs</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>4000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img7.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Medium • John Jacobs</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>5000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img8.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Wide • John Jacobs</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>5000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img9.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Wide • John Jacobs</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>5000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img10.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Wide • John Jacobs</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>6000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img11.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Wide • John Jacobs</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>6000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="glasses_images/glasses_img12.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Extra Wide • John Jacobs</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>6000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="inquiry.php" target="_blank"><a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a></a>
                                    </div>
                                </div>
                            </div>
                        </div>

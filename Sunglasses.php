                    ...
                    <ul class="navbar-nav me-auto ms-5 ">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="Sunglasses.php" aria-current="page">Sun-Glasses</a></li>
                            </ul>
                        </li>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="sunglasses_images/Sunglasses_img1.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size:Extra Wide • Ride</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>3000</b></p>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="sunglasses_images/Sunglasses_img2.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size:Wide • All Sports</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>3000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="sunglasses_images/Sunglasses_img3.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size:Medium • RIDE</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>3300</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="sunglasses_images/Sunglasses_img4.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size:Narrow • </p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>1500</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="sunglasses_images/Sunglasses_img5.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size:Wide • </p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>1500</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="sunglasses_images/Sunglasses_img6.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Wide • Crystal Clear</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>2000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="sunglasses_images/Sunglasses_img7.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Medium • Ride</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>3000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="sunglasses_images/Sunglasses_img8.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Wide • All Sports</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>3000</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="sunglasses_images/Sunglasses_img9.jpg" class="bd-placeholder-img card-img-top">
                            <div class="card-body">
                                <p class="card-text my-0">Size: Extra Wide • Ride</p>
                                <p class="card-text" style="font-size:20px"><i class="fa fa-inr" aria-hidden="true"></i><b>3500</b></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href="inquiry.php" target="_blank"><button type="button" class="btn btn-sm btn-outline-secondary">Inquiry Now</button></a>
                                    </div>

...
<body>
    ...
    <main>
        <div class="modal modal-sheet position-static d-block" style="margin-top: 9%; margin-bottom: 4%;">
            <div class="modal-dialog" role="document">
                <div class="modal-content rounded-4 shadow">
                    <img src="logo.png" class="p-3 mx-auto" width="25%">
                    <div class="modal-header p-5 pt-0 pb-4 border-bottom-0">
                        <h1 class="fw-bold mb-0 fs-2">Sign in To VisionVibe</h1>
                    </div>
                    ...
                    <div class="modal-body p-5 pt-0">
                        ...
                        <form method="post" action="login.inc.php">
                            ...
                            <input class="w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="submit" value="Sign in">
